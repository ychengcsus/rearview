...
@Service
@Transactional
public class GeoLocationInformationServiceImpl implements GeoLocationInformationService {

    private final Logger log = LoggerFactory.getLogger(GeoLocationInformationServiceImpl.class);
    ...
    public GeoLocationInformationServiceImpl(GeoLocationInformationRepository geoLocationInformationRepository, GeoLocationInformationMapper geoLocationInformationMapper) {
